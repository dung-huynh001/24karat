...
<div class="container-fluid">
    <form id="managerForm" class="py-3">
        ...
        <div class="mb-4 row">
            ...
            <div class="col-sm-10">
                <input type="text" id="name" name="name" class="form-control" value="{{$subscriptionUser->company_name}}" autocomplete="off">
        ...
        <div class="mb-4 row">
            ...
            <div class="col-sm-10">
                <div class="input-group">
                    <input type="text" id="name" name="name" class="form-control" value="{{$subscriptionUser->sub_domain}}" autocomplete="off">
